 ...
 */
public class WebSocketEntryPoint implements FeatureEntryPoint, Endpoint {
	...
	private static final String SERVER_CERT_FILENAME = "ISRGRootX1.crt"; //$NON-NLS-1$
	...
	private static final String SERVER_URL = "echo.microej.com"; //$NON-NLS-1$
	...
	/**
	 * Starts the {@link WebSocketEntryPoint} after initialisation.
	 *
	 * @param args
	 *            not used.
	 */
	...
	public void initSSLContext() throws NoSuchAlgorithmException, CertificateException, IOException, KeyStoreException,
		 ...
		 */
		try (InputStream in = WebSocketEntryPoint.class.getResourceAsStream(SERVER_CERT_PATH + SERVER_CERT_FILENAME)) {
