...
MicroEJ Java library: Simple Resty example using https connection
...
4. In  [RestEntryPoint.java](src/main/java/com/microej/example/iot/ssl/rest/RestEntryPoint.java)
