...
public class RestEntryPoint implements FeatureEntryPoint {
	...
	public static void initRestyHttpsContext() throws Exception{
		 ...
		 */
		try (InputStream in = RestEntryPoint.class.getResourceAsStream(SERVER_CERT_PATH + SERVER_CERT_FILENAME)) {
			/*
