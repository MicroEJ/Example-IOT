...
public class MutualAuthBackgroundService implements BackgroundService {
	...
	public static void main(String[] args) throws Exception{
		...
		new MutualAuthBackgroundService().onStart();
	...
	private static Certificate generateCertificate(String certificate, Map<String, Certificate> certificates)
		...
		if (myServerCert == null) {
			try (InputStream in = MutualAuthBackgroundService.class.getResourceAsStream(RESOURCE_DIR + certificate)) {
	...
	private static byte[] loadResource(String resourceName) throws IOException {
		try (InputStream stream = MutualAuthBackgroundService.class.getResourceAsStream(RESOURCE_DIR + resourceName)) {
